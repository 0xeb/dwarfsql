#!/usr/bin/env python3
"""
Converts dwarfsql_agent.md to a C++ header with embedded raw string literal.
Only regenerates if the hpp is older than the md or doesn't exist.

Run: python scripts/embed_prompt.py prompts/dwarfsql_agent.md src/common/dwarfsql_agent_prompt.hpp
"""
