...
/**
 * DwarfsqlMCPServer - MCP server for DWARFSQL
 *
...
class DwarfsqlMCPServer {
public:
    DwarfsqlMCPServer();
    ~DwarfsqlMCPServer();

    // Non-copyable
    DwarfsqlMCPServer(const DwarfsqlMCPServer&) = delete;
    DwarfsqlMCPServer& operator=(const DwarfsqlMCPServer&) = delete;
